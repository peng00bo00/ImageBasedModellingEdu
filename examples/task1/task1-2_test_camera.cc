...
public:
    ...
    math::Vec2d projection(math::Vec3d const & p3d){
        ...
        // P = Rp + t
        double X = R_[0]* p3d[0] + R_[1]* p3d[1] + R_[2]* p3d[2] + t_[0];
        double Y = R_[3]* p3d[0] + R_[4]* p3d[1] + R_[5]* p3d[2] + t_[1];
        double Z = R_[6]* p3d[0] + R_[7]* p3d[1] + R_[8]* p3d[2] + t_[2];
        ...
        double xd = (1 + k0 * r2 + k1 * r2 * r2) * x;
        double yd = (1 + k0 * r2 + k1 * r2 * r2) * y;
